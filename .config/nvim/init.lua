...
require('lazy').setup({
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = {
          c = true,
          cpp = true,
          javascript = true, -- having issue with conflicts with eslint
        }
        return {
          timeout_ms = 500,
  ...
  -- making moving from vim in tmux to another pane easier
  'christoomey/vim-tmux-navigator',

  { -- BarBar displays open buffers as "tabs" at the top of the screen
    'romgrk/barbar.nvim',
